...
import { Bot, BrainCircuit, Database, LineChart, Network, ArrowRight } from 'lucide-react';
    ...
    <main className="min-h-screen pt-32 pb-20">
      ...
      <section className="container mx-auto px-4 mt-32 relative z-10">
        ...
        >
          ...
          <h2 className="text-4xl font-bold text-white mb-6 relative z-10">Ready to Scale Your Operations?</h2>
          <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto relative z-10">
            Download our IP Blueprint to see exactly how our cognitive sourcing and algorithmic workflows can transform your business.
          </p>
